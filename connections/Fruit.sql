...
SET DEFINE OFF;
Insert into C##HITO.ADDRESS (ADDRESSID,UNIT_NUMBER,STREET_NUMBER,ADDRESS_LINE1,CITY,ADDRESS_LINE2,REGION,POSTAL_CODE,COUNTRYID) values (1,null,null,'Khu pho 6, phuong Linh Trung','Thu Duc',null,'Vietnam',721400,1);
REM INSERTING into C##HITO.COUNTRY
SET DEFINE OFF;
Insert into C##HITO.COUNTRY (COUNTRYID,COUNTRY_NAME) values (1,'Vietnam');
Insert into C##HITO.COUNTRY (COUNTRYID,COUNTRY_NAME) values (2,'North America');
REM INSERTING into C##HITO.LOGIN
SET DEFINE OFF;
Insert into C##HITO.LOGIN (LOGINID,USER_LOGIN_NAME,USER_PASSWORD) values (1,'HuyPhan','12345');
Insert into C##HITO.LOGIN (LOGINID,USER_LOGIN_NAME,USER_PASSWORD) values (2,'Hito','hito12345');
REM INSERTING into C##HITO.ORDER_LINE
SET DEFINE OFF;
Insert into C##HITO.ORDER_LINE (ORDERLINEID,QUANTITY,PRICE,SHOPORDERID,PRODUCTITEMID) values (1,2,278000,1,1);
Insert into C##HITO.ORDER_LINE (ORDERLINEID,QUANTITY,PRICE,SHOPORDERID,PRODUCTITEMID) values (2,3,144000,1,3);
REM INSERTING into C##HITO.ORDER_STATUS
SET DEFINE OFF;
Insert into C##HITO.ORDER_STATUS (ORDERSTATUSID,STATUS) values (1,'Preparing                                                                                                                    ');
Insert into C##HITO.ORDER_STATUS (ORDERSTATUSID,STATUS) values (2,'Delivering                                                                                                                   ');
Insert into C##HITO.ORDER_STATUS (ORDERSTATUSID,STATUS) values (3,'Delivered                                                                                                                    ');
Insert into C##HITO.ORDER_STATUS (ORDERSTATUSID,STATUS) values (4,'Rating                                                                                                                       ');
REM INSERTING into C##HITO.PAYMENT_TYPE
SET DEFINE OFF;
Insert into C##HITO.PAYMENT_TYPE (PAYMENTTYPEID,VALUE) values (1,10000000);
REM INSERTING into C##HITO.PRODUCT
SET DEFINE OFF;
Insert into C##HITO.PRODUCT (PRODUCTID,PRODUCTNAME,PRODUCTIMAGE,PRODUCTDESCRIPTION,PRODUCTCATEGORYID) values (1,'Envy New Zealand Apple',null,'Red Apple from New Zealand',1);
Insert into C##HITO.PRODUCT (PRODUCTID,PRODUCTNAME,PRODUCTIMAGE,PRODUCTDESCRIPTION,PRODUCTCATEGORYID) values (2,'Diva New Zealand Apple',null,'Red Apple from New Zealand countryside',1);
Insert into C##HITO.PRODUCT (PRODUCTID,PRODUCTNAME,PRODUCTIMAGE,PRODUCTDESCRIPTION,PRODUCTCATEGORYID) values (3,'Ngu Banana',null,'Grown mainly in the North, the most famous and delicious of which is in Dai Hoang village, where the soil and climate are perfect for banana trees to grow.',2);
Insert into C##HITO.PRODUCT (PRODUCTID,PRODUCTNAME,PRODUCTIMAGE,PRODUCTDESCRIPTION,PRODUCTCATEGORYID) values (4,'Laba Banana',null,'Grown mainly in Da Lat - Lam Dong.',2);
REM INSERTING into C##HITO.PRODUCT_CATEGORY
SET DEFINE OFF;
Insert into C##HITO.PRODUCT_CATEGORY (PRODUCTCATEGORYID,CATEGORYNAME) values (1,'Apple');
Insert into C##HITO.PRODUCT_CATEGORY (PRODUCTCATEGORYID,CATEGORYNAME) values (2,'Banana');
REM INSERTING into C##HITO.PRODUCT_ITEM
SET DEFINE OFF;
Insert into C##HITO.PRODUCT_ITEM (PRODUCTITEMID,SKU,QUANTITYINSTOCK,PRODUCTIMAGE,PRICE,PRODUCTID) values (1,'APP-RED-1',12,null,139000,1);
Insert into C##HITO.PRODUCT_ITEM (PRODUCTITEMID,SKU,QUANTITYINSTOCK,PRODUCTIMAGE,PRICE,PRODUCTID) values (3,'BAN-YELLOW-1',65,null,48000,3);
Insert into C##HITO.PRODUCT_ITEM (PRODUCTITEMID,SKU,QUANTITYINSTOCK,PRODUCTIMAGE,PRICE,PRODUCTID) values (4,'BAN-YELLOW-1',78,null,40000,4);
Insert into C##HITO.PRODUCT_ITEM (PRODUCTITEMID,SKU,QUANTITYINSTOCK,PRODUCTIMAGE,PRICE,PRODUCTID) values (2,'APP-RED-0.5',22,null,74950,2);
...
SET DEFINE OFF;
Insert into C##HITO.ROLES (ROLEID,ROLE_NAME,ROLE_DESCRIPTION) values (1,'Administrator',null);
Insert into C##HITO.ROLES (ROLEID,ROLE_NAME,ROLE_DESCRIPTION) values (2,'Supplier',null);
Insert into C##HITO.ROLES (ROLEID,ROLE_NAME,ROLE_DESCRIPTION) values (3,'Customer',null);
Insert into C##HITO.ROLES (ROLEID,ROLE_NAME,ROLE_DESCRIPTION) values (4,'Employee',null);
REM INSERTING into C##HITO.SHIPPING_METHOD
SET DEFINE OFF;
Insert into C##HITO.SHIPPING_METHOD (SHIPPINGMETHODID,NAME,PRICE) values (1,'GrabExpress',422000);
REM INSERTING into C##HITO.SHOP_ORDER
SET DEFINE OFF;
Insert into C##HITO.SHOP_ORDER (SHOPORDERID,ORDER_TOTAL,ORDER_DATE,SHIPPINGMETHODID,ORDERSTATUSID,ADDRESSID) values (1,422000,to_date('20-NOV-24','DD-MON-RR'),1,1,1);
REM INSERTING into C##HITO.SHOPPING_CART
SET DEFINE OFF;
Insert into C##HITO.SHOPPING_CART (SHOPPINGCARTID,USERID) values (1,2);
REM INSERTING into C##HITO.SHOPPING_CART_ITEM
SET DEFINE OFF;
Insert into C##HITO.SHOPPING_CART_ITEM (SHOPPINGCARTITEMID,QUANTITY,SHOPPINGCARTID,PRODUCTITEMID) values (1,2,1,1);
Insert into C##HITO.SHOPPING_CART_ITEM (SHOPPINGCARTITEMID,QUANTITY,SHOPPINGCARTID,PRODUCTITEMID) values (2,3,1,3);
REM INSERTING into C##HITO.SITE_USER
SET DEFINE OFF;
Insert into C##HITO.SITE_USER (USERID,EMAIL_ADDRESS,PHONE_NUMBER,USER_PASSWORD,LOGINID,ROLEID) values (1,'huyphan123@gmail.com','+84424125437','12345',1,1);
Insert into C##HITO.SITE_USER (USERID,EMAIL_ADDRESS,PHONE_NUMBER,USER_PASSWORD,LOGINID,ROLEID) values (2,'hito123@gmail.com','+84129584736','hito12345',2,3);
REM INSERTING into C##HITO.USER_ADDESS
SET DEFINE OFF;
Insert into C##HITO.USER_ADDESS (USERID,ADDRESSID,IS_DEFAULT) values (2,1,'Yes       ');
REM INSERTING into C##HITO.USER_PAYMENT_METHOD
SET DEFINE OFF;
Insert into C##HITO.USER_PAYMENT_METHOD (USERPAYMENTMETHODID,ACCOUNT_NUMBER,EXPIRY_DATE,IS_DEFAULT,PROVIDER,USERID,PAYMENTTYPEID) values (1,123876459,to_date('20-NOV-35','DD-MON-RR'),'Yes       ','BIDV',2,1);
REM INSERTING into C##HITO.USER_REVIEW
SET DEFINE OFF;
Insert into C##HITO.USER_REVIEW (USERREVIEWID,RATING_VALUE,USER_COMMENT,USERID,ORDERLINEID) values (1,4.5,'It is good!',2,1);
Insert into C##HITO.USER_REVIEW (USERREVIEWID,RATING_VALUE,USER_COMMENT,USERID,ORDERLINEID) values (2,5,'Wonderful',2,2);
